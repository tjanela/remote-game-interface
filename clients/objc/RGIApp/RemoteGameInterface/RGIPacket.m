...
- (NSString *)description{
	...
	NSString *payloadString = [[NSString alloc] initWithData:_payload encoding:NSUTF8StringEncoding];
	NSString *magicString = [[NSString alloc] initWithData:_magic encoding:NSUTF8StringEncoding];
