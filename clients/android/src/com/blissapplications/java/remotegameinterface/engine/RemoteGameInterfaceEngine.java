...
import com.blissapplications.remotegameinterface.*;
...
public class RemoteGameInterfaceEngine implements ILocationListener
{
	...
	public void checkState(final Activity callingActivity)
	{
		...
		else if (!lm.isProviderEnabled(LocationManager.GPS_PROVIDER))
		{
			...
			builder.setTitle("GeolocalizaÂâ€¹o desligada");
			builder.setMessage("Precisamos de obter a tua geolocalizaÂâ€¹o.\nQueres abrir as definiÂâ€ºes do teu dispositivo?");
			...
			builder.setNegativeButton("Agora nâ€¹o", new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					state = RemoteGameInterfaceState.LocationNotAvailable;
					for (IRemoteGameInterfaceEngineDelegate delegate : delegates)
